...
final class SecurityListViewController: UITableViewController {

    // Inject from host
    var viewModel: SecurityListViewModel!

    private var rows: [SecurityRow] = []
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        assert(viewModel != nil, "SecurityListViewModel must be injected")
    ...
    override func tableView(_ tableView: UITableView,
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "SecurityRowCell", for: indexPath) as? ProfileRowCell
